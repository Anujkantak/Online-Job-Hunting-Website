...
const MyProfile = () => {
  ...
  return (
    <div className="account_components_dark">
      <h3>My Profile</h3>

      <div className="form_group_dark">
        <label>Full Name</label>
      ...
      {user?.role === "Job Seeker" && (
        <div className="form_group_dark">
          <label>My Preferred Job Niches</label>
          <div className="preferred_niches_dark">
            <input type="text" disabled value={user?.niches?.firstNiche || ""} />
            <input type="text" disabled value={user?.niches?.secondNiche || ""} />
            <input type="text" disabled value={user?.niches?.thirdNiche || ""} />
          </div>
        </div>
      )}
